...
def main():
    ...
    # write the bipartite graph of the optimal solution (for now, complete bip graph - fix later)
    for (e,o) in itertools.product(evens, odds):
        print e,o,
    print ''
