...
static char rcsid[] = "$Id: fold.c,v 1.38 2007/12/19 10:27:42 ivo Exp $";
#ifdef __GNUC__
#define INLINE 
#else
#define INLINE 
...
{
	//write c to a file
	/*FILE * f123 = fopen("d:\\c_array_revamp.txt", "w");
	int f1c1;
	for(f1c1=0;f1c1<4097;f1c1++)
	{
		fprintf(f123, "%d\t%d \n", f1c1, c[f1c1]);
	}
	fclose(f123);*/
